...
public class PostRestControllerIT {
    ...
    public void setUp() throws Exception {
        ...
        childDTO_1 = Builder.buildPostDTO( "user","child title","child text",null,"cat1", LocalDateTime.now(),new ArrayList<>() );
        childDTO_1.setPostUrl( PostRestController.BASE_URL + "/" + "3" );
        childDTO_1.setParentPostUrl( PostRestController.BASE_URL + "/" + "1" );
        postDTO_1 = Builder.buildPostDTO( "user","post1 title","post1 text",null,"cat1", LocalDateTime.now(),new ArrayList<>() );
        postDTO_1.setPostUrl( PostRestController.BASE_URL + "/" + "1" );
        postDTO_1.getChildren().add( childDTO_1 );
        postDTO_2 = Builder.buildPostDTO( "user","post2 title","post2 text","http://images.com/2","cat1", LocalDateTime.now(),new ArrayList<>() );
        postDTO_2.setPostUrl( PostRestController.BASE_URL + "/" + "2" );
    }
    ...
    public void should_getOneParentPostsAndReturnOK_when_getPostsWithLimitSet() throws Exception {
        ...
        mockMvc.perform( get( PostRestController.BASE_URL )
    ...
    public void should_getPostById_when_getPost() throws Exception {
        String requestUrl = PostRestController.BASE_URL + "/1";
    ...
    public void should_returnHTTP_NOT_FOUND_when_getPostWithBadID() throws Exception {
        String requestUrl = PostRestController.BASE_URL + "/565";
    ...
    public void should_returnCREATED_when_createNewPostWithValidContent() throws Exception {
        ...
        mockMvc.perform( post( PostRestController.BASE_URL)
                .contentType( MediaType.APPLICATION_JSON )
    ...
    public void should_returnCREATED_when_createNewChildPost_requestBodyContainsValidPostDTO() throws Exception {
        ...
        mockMvc.perform( post( PostRestController.BASE_URL + "/1")
                .contentType( MediaType.APPLICATION_JSON )
    ...
    public void should_returnOK_when_updatePostWithValidRequestData() throws Exception {
        ...
        mockMvc.perform( put( PostRestController.BASE_URL + "/2")
                        .contentType( MediaType.APPLICATION_JSON )
                        .content( asJsonString( postDTO_2 ) ) )
                .andExpect( status().isOk() )
    ...
    public void should_deletePost() throws Exception {
        mockMvc.perform( delete( PostRestController.BASE_URL + "/2" ))
                .andExpect( status().isOk() );
    }
}